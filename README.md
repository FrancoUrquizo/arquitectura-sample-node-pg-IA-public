...
Este archivo crea las tablas `cursos` y `alumnos`, y las llena con datos de ejemplo (134 alumnos repartidos en 5 cursos).
...
| Archivo | Qué hace |
|---------|----------|
| `documents/database/script-postgress.sql` | Crea las tablas e inserta 5 cursos + 134 alumnos |
